...
// Mert Cihangiroglu 170201041 Data Visualization CS449 Assignment 3
// SVG Size
var width = 900,
	height = 500;
...
d3.csv("data/wealth-health-2014.csv", function(data){
	...
	svg.append("g")
		...
		.call(xAxis)
		.attr("transform", "translate(10, 480)"); // Transform and translate helps us move things around on y axis and y axis
